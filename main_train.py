...
tf.app.flags.DEFINE_string('checkpoint_path', '/data/ceph_11015/ssd/anhan/nba/FOTS_TF/checkpoints/bs32_540p_v1018_aughsv/', '')
tf.app.flags.DEFINE_boolean('restore', False, 'whether to resotre from checkpoint')
tf.app.flags.DEFINE_integer('save_checkpoint_steps', 1000, '')
tf.app.flags.DEFINE_integer('save_summary_steps', 100, '')
tf.app.flags.DEFINE_string('pretrained_model_path','/data/ceph_11015/ssd/anhan/nba/FOTS_TF/models/model.ckpt-733268', '')
...
tf.app.flags.DEFINE_string('training_data_dir', default='/data/ceph_11015/ssd/anhan/nba/FOTS_TF/training_img_1080p_v1018', help='training images dir')
tf.app.flags.DEFINE_string('training_gt_data_dir', default='/data/ceph_11015/ssd/anhan/nba/FOTS_TF/training_gt_1080p_v1018', help='training gt dir')
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
        ...
        for step in range(FLAGS.max_steps):
            ...
            if step % 100 == 0:
                ...
                start = time.time()
                print('Step {:06d}, detect_loss {:.4f}, recognize_loss {:.4f}, total loss {:.4f}, {:.2f} seconds/step, {:.2f} examples/second'.format(step, dl, rl, tl, avg_time_per_step, avg_examples_per_second))
