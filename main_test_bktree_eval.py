...
tf.app.flags.DEFINE_string('test_data_path', '/data/ceph_11015/ssd/templezhang/scoreboard/EAST/data/nba_test_1018.csv', '')
tf.app.flags.DEFINE_string('gpu_list', '0', '')
tf.app.flags.DEFINE_bool("check_teamname",False, '')
tf.app.flags.DEFINE_bool("just_infer", False, '')
tf.app.flags.DEFINE_string('checkpoint_path', '/data/ceph_11015/ssd/anhan/nba/FOTS_TF/checkpoints/bs16_540p_v1011', '')
tf.app.flags.DEFINE_string('output_dir', '/data/ceph_11015/ssd/anhan/nba/FOTS_TF/outputs/outputs_bs16_540p_v1018_1011', '')
